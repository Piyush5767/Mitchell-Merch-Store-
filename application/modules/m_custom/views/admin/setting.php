...
tinymce.init({
    ...
    toolbar: "code | insertfile undo redo | styleselect | forecolor backcolor | bold italic | alignleft aligncenter alignright alignjustify | numlist outdent indent | image dgmedia",	extended_valid_elements :"script[charset|defer|language|src|type]",
