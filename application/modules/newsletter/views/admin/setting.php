...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('newsletter/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('newsletter')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
	<!-- Tab panes -->
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			...
			<div class="form-group">
				<label><?php echo lang('newsletter_placeholder');?></label>
				<input type="text" class="form-control input-sm validate" name="newsletter_placeholder" placeholder="<?php echo lang('newsletter_buttonplaceholder_txt');?>" value="<?php echo $custom->placeholder; ?>"> 
			</div>

			<div class="form-group">
				<label><?php echo lang('newsletter_button');?><span class="symbol required"></span></label>
				<input type="text" class="form-control input-sm validate required" name="newsletter_button" placeholder="<?php echo lang('newsletter_button_placeholder');?>" value="<?php echo $custom->buttontxt; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('custom_admin_setting_button_validate');?>"> 
			</div>

			<div class="form-group">
				<label><?php echo lang('newsletter_button_class');?><span class="symbol required"></span></label>
				<input type="text" class="form-control input-sm validate required" name="newsletter_button_class" placeholder="<?php echo lang('newsletter_button_class_placeholder');?>" value="<?php echo $custom->buttonclass; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('custom_admin_setting_button_class_validate');?>"> 
			</div>
