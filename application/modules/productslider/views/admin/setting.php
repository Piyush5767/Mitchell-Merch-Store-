...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('productslider/admin/setting/save/'.$id); ?>">
					...
					<div class="col-sm-6">
						...
						<?php
							$show_product = array(
								...
								'featured_products'=>lang('m_product_admin_setting_featured_title'),								
							);
