...
<div class="form-group col-md-12 text-right">
	...
	<a class="btn btn-primary" href="javascript:void(0)" onclick="grid.module.setting('productslider', '')">
				...
				<?php 
					if(count($m_products) > 0)
					{
						...
						<tr>
							...
							<td>
								<a title="Click to choose this module" href="javascript:void(0)" onclick="grid.module.insert('productslider', 'index', <?php echo $m_product->id; ?>, '<?php echo $m_product->key; ?>', '<?php echo $m_product->title; ?>')">
									<?php echo $m_product->title; ?>
								</a>
							</td>
							<td><?php echo $m_product->key; ?></td>
							<td class="center"><i class="fa fa-pencil-square-o" onclick="grid.module.setting('productslider', <?php echo $m_product->id; ?>)" style="cursor: pointer;"></i><span class="page_ajax"><a href="<?php echo site_url().'productslider/admin/setting/remove/'.$m_product->id;?>"><i class="glyphicon glyphicon-remove" style="margin-left: 5px; color: #D9534F;"></i></span></td>
						</tr>
					<?php } ?>
				<?php } ?>
