...
<div class="tabpanel" role="tabpanel">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			...
			<div class="form-group">				<label><?php echo lang('contact_admin_setting_your_email_server_title');?><span class="symbol required"></span></label>				<input type="text" class="form-control input-sm validate required" name="emailfrom" placeholder="<?php echo lang('contact_admin_setting_your_email_server_place');?>" value="<?php echo $contact->emailfrom; ?>" data-type="email" data-msg="<?php echo lang('contact_admin_setting_your_email_server_validate');?>"> 				<p class="help-block"><?php echo lang('contact_admin_setting_your_email_server_eg');?></p>			</div>			
			<div class="form-group">
