...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	if(count($categories))
	{
		...
		if(isset($content->show_title) && $content->show_title == 'yes')
			echo '<h4 class="text-center block-title">'.$category->title.'</h4>';
			if($uri == '')
			echo '<span style="width:300px;" class="icon-title"><span class="line">&nbsp;</span><i class="fa fa-star"></i></span>';
		...
		echo '<div style="margin-top:30px;" class="module-categories">';
