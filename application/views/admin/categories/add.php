...
<div class="modal-body">		<?php if($type != 'design'): ?>
	...
	</div>		<?php else: ?>		<input type="hidden" value="0" name="cateLang[parent_id]">				<?php endif; ?>
	...
	<div class="tab-content" id="tab-content-lang">
		<div id="en" class="tab-pane active">						<input type="hidden" value="<?php echo $type; ?>" name="cateLang[type]">				
			<div class="form-group">
