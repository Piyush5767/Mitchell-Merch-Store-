	...
	<div class="modal-body">
		...
		<div class="tab-content" id="tab-content-lang">
			<div id="en" class="tab-pane active">			
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">Price<?php echo lang('Price'); ?></label>
					<div class="col-sm-6">
						<input type="text" placeholder="<?php echo lang('add_price'); ?>" value="<?php echo $art->add_price; ?>" class="form-control" id="artlang_title" name="art[add_price]">
					</div>
				</div>				
			</div>
		</div>
