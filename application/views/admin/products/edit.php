...
<script type="text/javascript" src="<?php echo base_url('/assets/js/customRequest.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('/assets/js/minify-list.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/listPagi.js'); ?>"></script>
						...
						<div class="panel panel-default">
							...
							<div id="tabs" class="tabs-left panel-body">
								<ul class="tabs-nav-left col-md-3">
									...
									<li><a href="#tabs-4"><?php echo lang('product_size_attribute'); ?></a></li>									
								</ul>
								<div class="tabs-content-right col-md-9">
									<div id="tabs-1">
											...
											<div class="col-sm-4">
												<?php if(count($layouts) > 0) { ?>
													...
													<select class="form-control input-sm" name="product[data][layout]">
														<option value="">- <?php echo lang('product_select_layout'); ?> -</option>
												...
												<?php } else { ?>
													<a href="<?php echo site_url('admin/page'); ?>"><?php echo lang('product_add_layout'); ?></a>
												<?php } ?>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="checkbox" name="product[data][printfulClrCode]" <?php if($product->printfulClrCode == 1) echo 'checked="checked"'; ?> value="<?php echo $product->printfulClrCode; ?>">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">
												<?php echo lang('product_printful_color_size'); ?>
											</label>
											<div class="col-sm-4">
												<input type="checkbox" name="product[data][printfulprcdepend]" <?php if($product->printfulprcdepend == 1) echo 'checked="checked"'; ?> value="<?php echo $product->printfulprcdepend; ?>">
											</div>
										</div>	
										<div class="form-group">
											<label class="col-sm-5 control-label">
												<?php echo lang('product_printful_color_differ'); ?><br/>
												<small><?php echo lang('product_printful_size_differ'); ?></small>
											</label>
											<div class="col-sm-4">
												<input type="checkbox" name="product[data][printfulsize_differ]" <?php if($product->printfulsize_differ == '1') echo 'checked="checked"'; ?> value="<?php echo $product->printfulsize_differ; ?>">
											</div>
										</div>											
										<div class="form-group">
											<label class="col-sm-5 control-label">
												<?php echo lang('product_printful_printful_product_id'); ?>
											</label>
											<div class="col-sm-4">
												<input type="text" class="form-control input-sm validate required" name="product[data][printful_productid]" value="<?php echo $product->printful_productid; ?>" data-minlength="2" data-maxlength="250" data-msg="<?php echo lang('product_validate_msg') . lang('product_sku');?>" placeholder="Printful Product Id">
											</div>
										</div>											
										<div class="form-group">
											<label class="col-sm-5 control-label">
												<?php echo lang('product_printful_product_id'); ?>
											</label>
											<div class="col-sm-4">
												<?php 
												$filetype = array(
												...
												echo form_dropdown('product[data][printful_printfile]', $filetype, $product->printful_printfile, 'class="form-control input-sm"');
												?>	
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">
												<?php echo lang('product_currency_type'); ?>
											</label>
											<div class="col-sm-4">
									...
									<div id="tabs-4">
										<div class="sizeattribute">
											...
											$count = 0;
											if(!empty($sizeattr)){
											$count = count($sizeattr['size']);										
												for($i=0; $i<$count;$i++){ $row = $i+1; ?>
														<div class="panel panel-simple" data-attribute="<?php echo $i+1; ?>">
															<div class="panel-heading">									
																<span class="attribute-title"><?php echo lang('product_printful_product_size'); ?></span>
																<div class="panel-tools">
																	<a class="btn btn-xs btn-link" onclick="dgUI.product.sizeattribute(this)" href="javascript:void(0);"><i class="glyphicon glyphicon-remove"></i></a>'
																</div>																
															</div>								
															<div class="panel-body">
																<div class="col-md-12">
																	<div class="row form-group">
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_dpi'); ?></center>
																			<input type="number" min="150" max="500" class="form-control input-sm" value="<?php echo $sizeattr['dpi'][$i]; ?>" name="product[sizeattr][<?php echo $i+1; ?>][dpi]" placeholder="ie: 150">
																		</div>																	
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_size'); ?></center>
																			<input type="text"  class="form-control input-sm" value="<?php echo $sizeattr['size'][$i]; ?>" name="product[sizeattr][<?php echo $i+1; ?>][size]" placeholder="ie: S">
																		</div>
																	</div>
																	<hr>
																	<div class="row form-group">
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_safe_width'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo $sizeattr['width'][$i]; ?>" name="product[sizeattr][<?php echo $i+1; ?>][width]" placeholder="ie: 11">
																		</div>																	
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_safe_height'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo $sizeattr['height'][$i]; ?>" name="product[sizeattr][<?php echo $i+1; ?>][height]" placeholder="ie: 15">
																		</div>																	
																	</div>																	
																	<div class="row form-group">
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_total_width'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo $sizeattr['totalwidth'][$i]; ?>" name="product[sizeattr][<?php echo $i+1; ?>][totalwidth]" placeholder="ie: 12">
																		</div>																	
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_total_height'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo $sizeattr['totalheight'][$i]; ?>" name="product[sizeattr][<?php echo $i+1; ?>][totalheight]" placeholder="ie: 16">
																		</div>
																	</div>
																	<hr><h4 class="printful-size-title text-center"><?php echo lang('product_back_size'); ?> </h4><p class="text-center"><small><?php echo lang('product_back_size_differ_txt'); ?></small></p>
																	<div class="row form-group">
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_safe_width'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo (array_key_exists('back_width',$sizeattr))? (property_exists($sizeattr['back_width'],$row))? $sizeattr['back_width']->$row : '' : ''; ?>" name="product[sizeattr][<?php echo $i+1; ?>][back_width]" placeholder="ie: 11">
																		</div>																	
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_safe_height'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo (array_key_exists('back_height',$sizeattr))? (property_exists($sizeattr['back_height'],$row))? $sizeattr['back_height']->$row : '' : ''; ?>" name="product[sizeattr][<?php echo $i+1; ?>][back_height]" placeholder="ie: 15">
																		</div>																	
																	</div>																	
																	<div class="row form-group">
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_total_width'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo (array_key_exists('back_totalwidth',$sizeattr))? (property_exists($sizeattr['back_totalwidth'],$row))? $sizeattr['back_totalwidth']->$row : '' : ''; ?>" name="product[sizeattr][<?php echo $i+1; ?>][back_totalwidth]" placeholder="ie: 12">
																		</div>																	
																		<div class="col-md-6">
																			<center><?php echo lang('product_printful_product_safe_height'); ?></center>
																			<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="<?php echo (array_key_exists('back_totalheight',$sizeattr))? (property_exists($sizeattr['back_totalheight'],$row))? $sizeattr['back_totalheight']->$row : '' : ''; ?>" name="product[sizeattr][<?php echo $i+1; ?>][back_totalheight]" placeholder="ie: 16">
																		</div>
																	</div>																	
																	<div class="row form-group">
																		<div class="col-md-6">
																			<center><?php echo lang('price'); ?></center>
																		  <input type="text" class="form-control"  value="<?php echo (array_key_exists('price',$sizeattr))? $sizeattr['price'][$i] : ''; ?>" name="product[sizeattr][<?php echo $i+1; ?>][price]">
																		</div>																	
																	</div>																	
																</div>
															</div>
													...
													<?php } ?>											
												<?php }?>
												<input type="hidden" id="sizeattr" value="<?php echo $count; ?>" >
										</div>
										<div class="form-group">
											<a href="javascript:void(0);" onclick="dgUI.product.sizeattribute('add')" class="btn btn-primary white">
												<?php echo lang('add_new'); ?>
											</a>
										</div>										
									</div>
								...
								<table class="table table-bordered table-hover" id="product-design">
									<thead>
										<tr>
											...
											<th rowspan="2" class="center" width="7%"><?php echo lang('product_color_title'); ?></th>
											<!--<th rowspan="2" class="center" width="5%"><?php echo lang('price'); ?> <small><?php lang('extra'); ?></small></th>-->
											<th colspan="4" class="center" width="76%"><?php echo lang('view'); ?></th>
											<th rowspan="2" class="center" width="5%"><?php echo lang('ordering'); ?></th>
											<th rowspan="2" class="center" width="7%"><?php echo lang('action'); ?></th>
										</tr>
										<tr class="title center">
											<th><small><?php echo lang('front').lang('product_design_price_optional'); ?></small></th>
											<th><small><?php echo lang('back').lang('product_design_price_optional'); ?></small></th>
											<th><small><?php echo lang('left').lang('product_design_price_optional'); ?></small></th>
											<th><small><?php echo lang('right').lang('product_design_price_optional'); ?></small></th>
										</tr>
									</thead>
									...
									<?php for( $i=0; $i<count($design->options); $i++ ) { ?>
										...
										<tr id="color_<?php echo $i; ?>">
											...
											<td rowspan="2" class="center"><input type="text" style="width:120px;" value="<?php  echo $design->options[$i]['color_title']; ?>" name="product[design][color_title][]"></td>
											...
											<td rowspan="2" class="center"><input type="text" name="product[design][ordering][]" value="<?php echo $design->options[$i]['ordering']; ?>" class="input-small ordering"></td>
											
											<td rowspan="2" class="center"><a onclick="dgUI.product.removeColor(this)" href="javascript:void(0)"><?php echo lang('remove'); ?></a></td>
										</tr>
										<tr class="color_<?php echo $i; ?>"><td class="center">+<small>(<?php echo lang('add'); ?>)</small>&nbsp;&nbsp;&nbsp;<input type="number" style="width:80px;" name="product[design][frontprice][]" min="0" value="<?php echo (array_key_exists('frontprice',$design->options[$i]))? $design->options[$i]['frontprice'] : ''; ?>"></td>
										<td class="center">+<small>(<?php echo lang('add'); ?>)</small>&nbsp;&nbsp;&nbsp;<input type="number" style="width:80px;" min="0" name="product[design][backprice][]" value="<?php echo (array_key_exists('backprice',$design->options[$i]))? $design->options[$i]['backprice'] : ''; ?>"></td>
										<td class="center">+<small>(<?php echo lang('add'); ?>)</small>&nbsp;&nbsp;&nbsp;<input type="number" style="width:80px;" name="product[design][leftprice][]" min="0" value="<?php echo (array_key_exists('leftprice',$design->options[$i]))? $design->options[$i]['leftprice'] : ''; ?>"></td>
										<td class="center">+<small>(<?php echo lang('add'); ?>)</small>&nbsp;&nbsp;&nbsp;<input type="number" style="width:80px;" name="product[design][rightprice][]" min="0" value="<?php echo (array_key_exists('rightprice',$design->options[$i]))? $design->options[$i]['rightprice'] : ''; ?>"></td></tr>
									<?php } ?>
