...
<ul class="nav nav-tabs">
  ...
  <li><a href="#analystic" data-toggle="tab"><?php echo lang('setting_tab_setting_analystic'); ?></a></li>    
...
<div class="tab-content">
	...
	<div class="tab-pane active" id="home">
		<div class="row">
			<div class="col-md-8">				
				...
				<div class="form-group row">
					<label class="col-sm-3 control-label">
						<?php echo lang('setting_shop_site_robots'); ?>
						<span class="dgtooltip fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="<?php echo lang('setting_shop_site_robots_des'); ?>"></span>
					</label>
					<div class="col-sm-8">
						<textarea rows="3" cols="60" class="form-control" name="setting[meta_robots]"><?php echo $setting->meta_robots; ?></textarea>
					</div>
				</div>				
			</div>
		...
		<div class="row">
			<div class="col-md-8">
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<select name="setting[currency_id]" onchange="currencyCode()" class="form-control chosen-select" data-placeholder="Choose a Currencies">
				...
				<div class="row col-md-12">
					...
					<div class="form-group row">						
						<div class="col-sm-6">
							<label class="help-block col-sm-6" style="padding:0px;margin-right:15px;">Text Price</label>
							<input type="text" name="setting[text_price]" value="<?php if (isset($setting->text_price)) echo $setting->text_price; ?>" class="input-sm col-sm-4">
						</div>
						<div class="col-sm-6"></div>
					</div>
					<div class="form-group row">						
						<div class="col-sm-6">
							<label class="help-block col-sm-6" style="padding:0px;margin-right:15px;">Image Upload Price</label>
							<input type="text" name="setting[upload_image_price]" value="<?php if (isset($setting->upload_image_price)) echo $setting->upload_image_price; ?>" class="input-sm col-sm-4">
						</div>
						<div class="col-sm-6"></div>
					</div>					
					<div class="form-group row">
	...
	<div class="tab-pane" id="shop">
		...
		<div class="pull-left col-md-6">
			<h4><?php echo lang('settings_title_printful'); ?></h4>
			<div class="form-group row">
				<label class="col-sm-3 control-label"><?php echo lang('settings_printful_client'); ?></label>
				<div class="col-sm-6">
					<input type="text" class="form-control input-sm" value="<?php if(isset($setting->printful_client)) echo $setting->printful_client; ?>" name="setting[printful_client]">
				</div>
			</div>		
	...
	<!-- start setting lang -->
	<div style=" height: 350px;" class="tab-pane" id="analystic">
		<div class="row">
			<div class="pull-left col-md-6">
				<h4><?php echo lang('settings_title_google'); ?></h4>
				<div class="form-group row">
					<label class="col-sm-4 control-label"><?php echo lang('settings_google_client_email'); ?></label>
					<div class="col-sm-6">
						<input type="text" class="form-control input-sm" value="<?php if(isset($setting->google_client_email)) echo $setting->google_client_email; ?>" name="setting[google_client_email]">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-4 control-label"><?php echo lang('settings_google_profile_id'); ?></label>
					<div class="col-sm-6">
						<input type="text" class="form-control input-sm" value="<?php if(isset($setting->google_profile_id)) echo $setting->google_profile_id; ?>" name="setting[google_profile_id]">
					</div>
				</div>				
			</div>
		</div>
...
<script type="text/javascript">
	...
	{
		var code = jQuery('.chosen-select option:selected').attr('data-code');
		var symbol = jQuery('.chosen-select option:selected').attr('data-symbol');
		jQuery('#shop-currency_code').val(code);
		jQuery('#shop-currency_symbol').val(symbol);
	}
