		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="page-save" class="page-save" action="<?php echo site_url('admin/layout/save'); ?>" method="POST">
					 ...
					 <textarea class="form-control input-sm" style="display:none;" rows="2" id="page_file" name="file"></textarea>										<hr/>					<h4 class="text-center"><?php echo lang('meta_info'); ?></h4>
					 <div class="form-group">
					 <label class="font-bold"><?php echo lang('meta_exists'); ?></label>
					 <select class="form-control input-sm" name="page[meta_exists]">
					 <option <?php if($page->meta_exists == 0) echo 'selected="selected"'; ?> value="0"><?php echo lang('no'); ?></option>
					 <option <?php if($page->meta_exists == 1) echo 'selected="selected"'; ?> value="1"><?php echo lang('yes'); ?></option>	
					 </select>
					 </div>	
					 <div class="form-group">
					...
					<div class="form-group">
						<label class="font-bold"><?php echo lang('meta_robots'); ?></label>
						<textarea class="form-control input-sm" rows="2" name="page[meta_robots]"><?php echo $page->meta_robots; ?></textarea>
					</div>					 
