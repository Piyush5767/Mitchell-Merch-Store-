		...
		<table id="sample-table-1" class="table table-bordered table-hover">
			<thead>
				<tr>
					...
					<th class="center"><?php echo lang('orders_admin_order_shipping_status'); ?></th>					
				...
				<tr>
					...
					<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							<div class="btn-group">
								<?php $order_status = array('canceled'=>'btn-danger','fulfilled'=>'btn-success','partial'=>'btn-primary'); 
								if (!array_key_exists($order->shipping_status,$order_status)){ ?>
									...
									<?php echo ucwords($order->shipping_status); ?><span class="caret" style="margin-left: 5px;"></span></a>
									<ul class="dropdown-menu" role="menu">										
									<li><a href="<?php echo site_url('/user/cancelorder/admin/'.$order->id); ?>"><i style='margin-right: 5px;' class='clip-radio-checked'></i><?php echo 'Cancel Order' ?></a></li>
									</ul>
								<?php }else{ ?>
									<a class="btn btn <?php echo $order_status[$order->shipping_status]; ?> btn-xs tooltips dropdown-toggle" data-toggle="dropdown" href="javascript:void();">
									<?php echo ucwords($order->shipping_status); ?>
									</a>
								<?php } ?>
							</div>						
						</div>	
