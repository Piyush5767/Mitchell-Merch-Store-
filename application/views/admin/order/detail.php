...
<div id="order_detail_body">
						...
						<div class="row">
							...
							<div class="col-sm-5 pull-left">
								<div class="order_detail">
									...
									<div class="row">
										<label class="col-sm-5 text-left"><?php echo lang('name'); ?>:</label>
									...
									<div class="row">
										<label class="col-sm-5 text-left"><?php echo lang('username'); ?>:</label>
										<span class="col-sm-7 text-left">
									...
									<div class="row">
										<label class="col-sm-5 text-left"><?php echo lang('email'); ?>:</label>
			...
			<table id="table_order_detail" class="table table-bordered table-hover" style="margin-top: 20px;">
				<thead>
					<tr>
						...
						<th class="center" style="width: 8%;"><?php echo lang('sku'); ?></th>
						<!--<th class="center" style="width: 12%;"><?php echo lang('orders_admin_status_of_order_product_title'); ?></th>-->
						<th class="center" style="width: 15%;"><?php echo lang('orders_admin_product_price_title'); ?></th>
						<th class="center" style="width: 18%;"><?php echo lang('orders_admin_product_clipart_title'); ?></th>
						<th class="center" style="width: 18%;"><?php echo lang('orders_admin_product_attributes_title'); ?></th>
				...
				<tbody>					
					...
					<?php foreach($items as $product){?>
						<tr>
							...
							<td class="center"><?php echo $product->product_sku;?></td>
							<!--<td class="center">
								<?php 
									$option = array(
							...
							<td class="center"><?php echo $setting->currency_symbol.number_format($product->product_price, 2);?></td>
							<td class="center"><?php echo $setting->currency_symbol.number_format($product->price_clipart, 2);?></td>
							<td class="center"><?php echo $setting->currency_symbol.number_format($product->price_attributes, 2);?></td>
							...
							<td class="center"><?php echo $setting->currency_symbol.number_format($total_row, 2);?></td>
						</tr>
						<?php 
					...
					<tr>
						...
						<td class="center"><?php echo $setting->currency_symbol.number_format($shipping_price, 2);?></td>
					</tr>
					...
					<tr>
						...
						<td class="center"><?php echo $setting->currency_symbol.number_format($payment_price, 2) ;?></td>
					</tr>
					...
					<tr>
						...
						<td class="center"><?php echo $setting->currency_symbol.number_format($order->discount, 2) ;?></td>
					</tr>
					...
					<tr>
						...
						<td class="center" colspan="7"><strong><?php echo $setting->currency_symbol.number_format($total, 2);?><strong></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<?php $shipping_obj = json_decode($order->shipping_obj); $lang = getLanguages(); ?>
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">Shipment Tracking</h4>
				</div>				
				<div class="panel-body">
					<div class="row">
						<div class="col-md-8">
							...
							<div class="row">
								<label class="col-md-3 col-xs-6 text-left">Shipment Type:</label>
							...
							<div class="row">
								<label class="col-md-3 col-xs-7 text-left">Shipment Price:</label>
								<span class="col-md-9  col-xs-5 text-left">$<?php echo $shipping_obj->price; ?></span>
							</div>			
						
							<div class="row">
								<label class="col-md-3 col-xs-7 text-left">Shipment Status:</label>
...
<script type="text/javascript">
	...
	function addNote()
	{
		...
		if(val.trim() == ''){
			alert('<?php echo lang('order_admin_empty_note_error_msg'); ?>');			
		}else{
			jQuery.ajax({
				type: "POST",
