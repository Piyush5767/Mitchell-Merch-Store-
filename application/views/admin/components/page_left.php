	...
	<div class="main-navigation navbar-collapse collapse">
		...
		<ul class="main-navigation-menu">
			...
			<li <?php if($segments[2] == 'orders') echo 'class="active open"' ?>>
				...
				<ul class="sub-menu">
					<li <?php if(($segments[2] == 'orders' && !isset($segments[3])) || ($segments[2] == 'orders' && isset($segments[3]) && $segments[3] == 'detail')) echo 'class="active open"'; ?>>
						<a href="<?php echo site_url("admin/orders"); ?>">
							<span class="title"><?php echo lang('page_left_admin_customer_orders');?></span>
						</a>
					</li>
					<li <?php if($segments[2] == 'orders' && isset($segments[3]) && ($segments[3] == 'refundorders' || $segments[3] == 'refundfailure')) echo 'class="active open"'; ?>>
						<a href="<?php echo site_url("admin/orders/refundorders"); ?>">
							<span class="title"><?php echo lang('page_left_admin_customer_refundorders');?></span>
						</a>
					</li>					
				</ul>
			</li>
			<li <?php if($segments[2] == 'designClipart') echo 'class="active open"' ?>>
				<a href="javascript:void(0);">
					<i class="clip-pictures"></i>
					<span class="title"><?php echo lang('page_left_admin_design_clipart')?></span>
					<i class="icon-arrow"></i>
					<span class="selected"></span>					
				</a>
				<ul class="sub-menu">
					<li class="<?php if($segments[2] == 'designClipart' && (!isset($segments[3]))) echo 'active';?>">
						<a href="<?php echo site_url("admin/designClipart"); ?>">
							<span class="title"><?php echo lang('page_left_admin_list_custom_clipart');?></span>
						</a>
					</li>				
					<li class="<?php if($segments[2] == 'designClipart' && (isset($segments[3]) && $segments[3] == 'edit')) echo 'active ';?>">
						<a href="<?php echo site_url("admin/designClipart/edit"); ?>">
							<span class="title"><?php echo lang('page_left_admin_design_custom_clipart');?></span>
						</a>
					</li>
				</ul>
			</li>				
			...
			<li <?php if($segments[2] == 'newsletter') echo 'class="active open"' ?>>
				<a href="javascript:void(0);">
					<i class="fa fa-envelope-o"></i>
					<span class="title"><?php echo lang('page_left_admin_newsletter');?></span>
					<i class="icon-arrow"></i>
					<span class="selected"></span>
				</a>
				<ul class="sub-menu">
					<li class="<?php if($segments[2] == 'newsletter' && (!isset($segments[3]) || $segments[3] == 'edit')) echo 'active';?>">
						<a href="<?php echo site_url("admin/newsletter"); ?>">
							<span class="title"><?php echo lang('page_left_admin_list_subscribers');?></span>
						</a>
					</li>
				</ul>
			</li>			
