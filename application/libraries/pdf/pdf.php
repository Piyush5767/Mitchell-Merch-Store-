		...
		$html .= '<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px;">
				...
				<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px; width: 100%;">
					<tr style="text-align: center; background-color: #F7F7F9; color: #333333;">
						...
						<td style="width: 20%; border: 0.3px solid #ccc;">
					...
					$html .= '
						<tr>
							<td colspan="8" style="text-align: right; border: 0.3px solid #ccc; ">'.$lang['shipment_fee'].':';
					...
					<tr>
						<td colspan="8" style="text-align: right; border: 0.3px solid #ccc; ">'.$lang['payment_fee'].':';
					...
					<tr>
						<td colspan="8" style="text-align: right; border: 0.3px solid #ccc; ">'.$lang['discount'].':';
					...
					<tr>
						<td colspan="8" style="text-align: right; border: 0.3px solid #ccc; ">
							'.$lang['total'].'
						</td>
						<td style="text-align: right; border: 0.3px solid #ccc; ">';
										...
										foreach($vector as $value){
											...
											<tr>
												...
												if(isset($value['text'])){
													...
													$img = $value['thumb'];
													if($value['clipartTpe'] == 'uploadedimage'){
														$order = $this->CI->db->get_where('dg_order_uploadimage',array('clipart_id'=>$value['clipart_id'],'order_id'=>$product->order_id))->row();
														$img = base_url().$order->thumb;													
													}										
													$subtable .= '<img src="'.$img.'" alt=""/>';
												}
												$subtable .= '
												</td>
											</tr>';
											foreach($value as $k=>$v){
												if($k != 'text' && $k!='clipartTpe' && $k!='clipart_id' && $k != 'zIndex' && $k != 'type' && $k != 'svg' && $k != 'outlineC' && $k != 'outlineW' && $k != 'title' && $k != 'file_name' && $k != 'file' && $k != 'thumb' && $k != 'url' && $k != 'change_color'){
													$subtable .= '
														<tr>
															<td></td>';
		...
		if($data['logo'] != '')
		{
			$html .= '<img src="'.base_url($data['logo']).'" style="width: 110px; height: 40px;"/><br />';
				...
				<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px; width: 100%;">
					...
					$html .= '
						<tr>
							<td colspan="7" style="text-align: right; border: 0.3px solid #ccc; ">'.$this->language('shipment_fee', $lang).':';
							if (count($data['shipping'])) { 
								$html .= '
					...
					<tr>
						<td colspan="7" style="text-align: right; border: 0.3px solid #ccc; ">'.$this->language('payment_fee', $lang).':';
						if (count($data['payment'])) {							
							$html .= '
					...
					<tr>
						<td colspan="7" style="text-align: right; border: 0.3px solid #ccc; ">'.$this->language('cart_discount', $lang).':';
						if (count($data['discounts'])) {							
							$html .= '<br><small>'.$data['discounts']->name.': <a href="'.site_url().'"><strong>
							'.$data['discounts']->code.'</strong></a></small>';
						}
					...
					<tr>
						<td colspan="7" style="text-align: right; border: 0.3px solid #ccc; ">
