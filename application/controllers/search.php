...
class Search extends Frontend_Controller 
{
	...
	{		
		...
		$this->load->model('layout_m');		$layout = $this->layout_m->getDesignLayout('search/all');				$data['title']				=  $layout->title;				$data['meta_keywords']		=  $layout->meta_keywords;				$data['meta_description']	=  $layout->meta_description;		$data['meta_robots']		=  $layout->meta_robots;			
