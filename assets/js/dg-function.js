			...
			jQuery(e).dynatree({
				...
				onClick: function (node, event) {
					...
					if (event.target.className == 'dynatree-title')
					{
						...
						jQuery.ajax({url: ajax_url+'/'+ cateId}).done(function( data ) {
	...
	product:{
		...
		sizeattribute: function(type){
			if(type == 'add')
			{
				...
				id = parseInt(id) + 1;
				*/
				var custom = jQuery('.sizeattribute');
				//var child = custom.children('.panel-simple').last();
				var cntid = jQuery("#sizeattr").val();				
				var id = parseInt(cntid)+1;	
				var html = '<div class="panel panel-simple" data-attribute="'+id+'">'
								+'<div class="panel-heading">'									
									+'<span class="attribute-title">Product Size</span>'
									+'<div class="panel-tools">'
								...
								+'<div class="panel-body">'
									+'<div class="col-md-12">'
										+'<div class="row form-group">'
											+'<div class="col-md-6">'
												+'<center>Product DPI</center>'
												+'<input type="number" min="1" max="500" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][dpi]" placeholder="ie: 150">'
											+'</div>'										
											+'<div class="col-md-6">'
												+'<center>Product Size</center>'
												+'<input type="text" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][size]" placeholder="ie: XL">'
											+'</div>'
										+'</div>'
										+'<hr>'
										+'<div class="row form-group">'
											+'<div class="col-md-6">'
												+'<center>Product Safe Width(inch)</center>'
												+'<input type="number" min="1" max="50" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][width]" placeholder="ie: 11">'
											+'</div>'										
											+'<div class="col-md-6">'
												+'<center>Product Safe Height(inch)</center>'
												+'<input type="number" min="1" max="50" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][height]" placeholder="ie: 16">'
											+'</div>'
										+'</div>'
										+'<div class="row form-group">'
											+'<div class="col-md-6">'
												+'<center>Product Total Width(inch)</center>'
												+'<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][totalwidth]" placeholder="ie: 12">'
											+'</div>'										
											+'<div class="col-md-6">'
												+'<center>Product Total Height(inch)</center>'
												+'<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][totalheight]" placeholder="ie: 16">'
											+'</div>'
										+'</div>'	
										+'<hr><h4 class="printful-size-title text-center">Back Size </h4>'+'<p class="text-center"><small>(If back size differ compare to front)</small></p>'										
										+'<div class="row form-group">'
											+'<div class="col-md-6">'
												+'<center>Product Safe Width(inch)</center>'
												+'<input type="number" min="1" max="50" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][back_width]" placeholder="ie: 11">'
											+'</div>'										
											+'<div class="col-md-6">'
												+'<center>Product Safe Height(inch)</center>'
												+'<input type="number" min="1" max="50" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][back_height]" placeholder="ie: 16">'
											+'</div>'
										+'</div>'
										+'<div class="row form-group">'
											+'<div class="col-md-6">'
												+'<center>Product Total Width(inch)</center>'
												+'<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][back_totalwidth]" placeholder="ie: 12">'
											+'</div>'										
											+'<div class="col-md-6">'
												+'<center>Product Total Height(inch)</center>'
												+'<input type="number" min="1" max="100" step="0.01" class="form-control input-sm" value="" name="product[sizeattr]['+id+'][back_totalheight]" placeholder="ie: 16">'
											+'</div>'
										+'</div>'										
										+'<hr><div class="row form-group">'
											+'<div class="col-md-6">'
												+'<center>Price</center>'
											 +'<input type="text" class="form-control"  name="product[sizeattr]['+id+'][price]">'
											+'</div>'																	
										+'</div>'										
									+'</div>'
								+'</div>'
							+'</div>';
				jQuery("#sizeattr").val(id);			
				custom.append(html);				
			}else{
				jQuery(type).parents('.panel-simple').remove();
			}
		...
		addColor: function(title, hex)
		{
			...
			var tr = document.createElement('tr');
				tr.id = 'color_'+count;				
			var html = '<td rowspan="2" class="center"><input type="hidden" name="product[design][color_hex][]" value="'+hex+'" />';
			...
			html = html + '</td>';
			html = html + '<td rowspan="2" class="center"><input type="text" style="width:120px;" name="product[design][color_title][]" value="'+title+'" /></td>';
			...
			html = html + '<td rowspan="2" class="center"><input type="text" class="input-small ordering" value="'+count+'" name="product[design][ordering][]" /></td>';
			html = html + '<td rowspan="2" class="center"><a href="javascript:void(0)" onclick="dgUI.product.removeColor(this)">Remove</a></td>';
			
			addPrice =  '<td class="center"><input type="number" style="width:80px;" name="product[design][frontprice][]" min="0" value="0"></td>'
					   +'<td class="center"><input type="number" style="width:80px;" name="product[design][backprice][]"  min="0" value="0"></td>'
					   +'<td class="center"><input type="number" style="width:80px;" name="product[design][leftprice][]"  min="0" value="0"></td>'
					   +'<td class="center"><input type="number" style="width:80px;" name="product[design][rightprice][]" min="0" value="0"></td>';
									
			tr.innerHTML = html;			
			tbody[0].appendChild(tr);
			var tr2 = document.createElement('tr');
			tr2.className = 'color_'+count;
			tr2.innerHTML = addPrice;	
			tbody[0].appendChild(tr2);
		},
		removeColor: function(e)
		{
			var id = jQuery(e).closest('tr').attr('id');
			jQuery('#'+id+',.'+id).remove();
		},
		...
		color:{
			...
			find: function(type, e){
				...
				$('#paginationmdl').css('display','block');
				if(type == 'key')
				{
					if(value.trim() == ''){
						color.each(function(){						
						...
						color.each(function(){						
							...
							if(title.toLowerCase().indexOf(value.toLowerCase()) != -1 ){
								jQuery(this).css('display', 'block'); 
								jQuery(this).closest('div').find('.remove-item-btn').css('display', 'block');
								cnt = cnt+1;
							}else{
								jQuery(this).css('display', 'none');
								jQuery(this).closest('div').find('.remove-item-btn').css('display', 'none');
							}
						});						
					}					
					if(cnt > 32 || value.trim() == ''){
						$('#paginationmdl').css('display','block');						
					}else{
						$('#paginationmdl').css('display','none');
					}
					return;
				}
